        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("getPrice".equals(methodName)){
                ...
                org.apache.ws.axis2.GetPriceResponse getPriceResponse4 = null;
	                        org.apache.ws.axis2.GetPrice wrappedParam =
                                                             (org.apache.ws.axis2.GetPrice)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.apache.ws.axis2.GetPrice.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getPriceResponse4, false, new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                                    "getPrice"));
